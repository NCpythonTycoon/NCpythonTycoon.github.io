...
def update_playlist(playlist):
	...
	if choice == 1:
		new_playlist_name = input("Enter new name for the playlist: ") + "\n" 
		playlist.name = new_playlist_name
		print("Updated Successfully!!!")
		return playlist 
	if choice == 2:
		new_playlist_description = input("Enter new description for the playlist: ") + "\n"
