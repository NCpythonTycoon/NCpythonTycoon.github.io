function validate() {
	...
	// nguyencamonhnhatnguyencaominhnhatnguyencaominhnhnguyencamonhnhatnguyencaominhnhatnguyencaominhnnguyen
	// Dung.match ("123
	
	return true;
	// if firstname = true; 
	// firstname has to contain only characters and between 1 - 30 characters 
	// and lastname ha sto contain only characters and between 1 - 30 characters 
	// phone numbers has to contains only numbers and between 1- 10 characters 
